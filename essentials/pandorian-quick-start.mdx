...
// TODO @amit need to add GitLab, AzureDevOps
...
You have two options: create a custom guideline from scratch, or import one from our catalog of 2,000+ pre-built guidelines.
...
// TODO @amit add from file, from confluence
...
- Check out [Core Concepts](https://docs.pandorian.ai/essentials/pandorian-core-concepts) for deeper understanding of how guidelines work
- Visit [Integration Guides](https://docs.pandorian.ai/essentials/pandorian-integration-guides) to set up PR scanning and CI/CD enforcement
