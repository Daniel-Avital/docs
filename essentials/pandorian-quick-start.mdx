...
Once your scan completes, navigate to the **Scans** page and double-click the completed scan. You'll see:

- **Non-Compliant Files:** Files that contain violations
- For each violation: the guideline violated, a detailed explanation of why the code violates it, and the specific lines involved
