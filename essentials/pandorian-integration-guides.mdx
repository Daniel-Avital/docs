...
**Best Practice:** Set critical guidelines (security, production-readiness, API design) to **PR Scan**. Use **Full Scan** for broader quality checks that don't need immediate PR enforcement.
